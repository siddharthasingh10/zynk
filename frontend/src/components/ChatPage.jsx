...
const ChatPage = () => {
    ...
    return (
        <div className='flex ml-[16%] h-screen'>
            ...
            <section className='w-16 md:w-1/4 my-8 '>
  <h1 className='font-bold mb-4 px-3 text-xl truncate'>{user?.username}</h1>
      ...
      suggestedUsers.map((suggestedUser) => {
        ...
        return (
          <div
            ...
            className='flex flex-col md:flex-row gap-2 md:gap-3 items-center p-2 md:p-3 hover:bg-gray-50 cursor-pointer'
          >
  ...
  onKeyDown={(e) => {
    if (e.key === 'Enter') {
      e.preventDefault(); // to avoid accidental form submits
