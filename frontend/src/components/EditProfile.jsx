...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.put('http://localhost:5000/api/v1/user/profile/edit', formData, {
                headers: {
        ...
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div>
                    ...
                    <Textarea value={input.username} onChange={(e) => setInput({ ...input, username: e.target.value })} name='username' className="focus-visible:ring-transparent" />
                </div>
                <div>
